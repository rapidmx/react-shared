...
///////////////////////////////////////////////////////////////////////////////
// Global test setup. Vitest applies `setupFiles` across every test environment configured for this
// project, including the plain `node` environment most of this package's tests run under — guard
// everything here on `document` actually existing so this file is a no-op for those tests rather than
// throwing on a DOM API that isn't present.
